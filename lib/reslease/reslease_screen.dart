...
//--------Hàm buttom phát hành-----------------
  Future<void> PhatHanh() async {
    ...
    if (_brand.text == null || _brand.text == "") {
      showMessage(
          context, "Lỗi nhập liệu", "Vui lòng chọn nội dung thanh toán");
      return;
    }
    ...
    //   createPdf(bienlai64);
    // } else {
    //   showMessage('Lỗi phát hành', result);
    // }
  }
...
//                          _brand.text = data['id'];
  ...
  // void showMessage(String s, String t) {}
}
